    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollSnap
    {
        ...
        void LateUpdate()
        {
            ...
            if (_lerp)
            {
                ...
                _listContainerTransform.localPosition = Vector3.Lerp(_listContainerTransform.localPosition, _lerpTarget, LerpSpeed * Time.deltaTime);
        ...
        public void ChangePageWithSpeed(int page, float speed)
        {
            LerpSpeed = speed;
            ChangePage(page);
        }
